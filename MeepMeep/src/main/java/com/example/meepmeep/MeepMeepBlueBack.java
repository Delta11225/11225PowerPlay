...
//                            Pose2d startPose = new Pose2d(-40, 70 - (12.25 / 2.0), Math.toRadians(270));
              ...
              .splineToLinearHeading(new Pose2d(5.6, 31, Math.toRadians(240)), Math.toRadians(240))
              .addDisplacementMarker(() -> {
              ...
              // Go to turn
              .splineToLinearHeading(new Pose2d(16, 12, Math.toRadians(0)), Math.toRadians(0))
              .addDisplacementMarker(() -> {
              ...
              .splineToLinearHeading(new Pose2d(28.5, 8.5, Math.toRadians(240)), Math.toRadians(240))
              .addDisplacementMarker(() -> {
              })
              .back(10)
              .addDisplacementMarker(() -> {
