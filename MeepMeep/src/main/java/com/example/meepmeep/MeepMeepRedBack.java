...
//                            Pose2d startPose = new Pose2d(-40, 70 - (12.25 / 2.0), Math.toRadians(270));
              ...
              .splineToLinearHeading(new Pose2d(5.6, -31, Math.toRadians(120)), Math.toRadians(120))
              .addDisplacementMarker(() -> {
              ...
              .splineToLinearHeading(new Pose2d(28.5, -8.5, Math.toRadians(120)), Math.toRadians(120))
              .addDisplacementMarker(() -> {
              })
              .back(10)
              .addDisplacementMarker(() -> {
