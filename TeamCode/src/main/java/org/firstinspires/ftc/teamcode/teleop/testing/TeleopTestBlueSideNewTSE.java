...
@TeleOp(name="TeleOp test new TSE")
@Disabled
public class TeleopTestBlueSideNewTSE extends LinearOpMode {
    ...
    public void peripheralMove(){
        ...
        // TSE Arm
//        if (ControlConfig.collectTseArm) {
//            robot.tseServo.setPosition(Constants.tseArmCollectPosition);
//        }
//        if (ControlConfig.deployTseArm) {
//            robot.tseServo.setPosition(Constants.tseArmDeployPosition);
//            // Necessary, as otherwise the servos don't have enough torque
//            sleep(500);
//        }
//        if (ControlConfig.releaseTseArm) {
//            robot.tseServo.setPosition(Constants.tseArmReleasePosition);
//
//        }
        if (ControlConfig.initTseArm) {
            robot.tseServo.setPosition(Constants.tseArmInitPosition);
